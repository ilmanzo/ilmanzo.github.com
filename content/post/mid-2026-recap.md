...
An extra special shout-out to some of the local communities that made this year so memorable. I had a truly fantastic time collaborating and sharing ideas with the awesome folks at [GDG Vicenza](https://gdg.community.dev/gdg-vicenza/), [GDG Venezia](https://gdg.community.dev/gdg-venezia/), [BacaroTech](https://bacarotech.github.io/) and [Mantova Dev](https://linktr.ee/mantovadev), as well as participating in the wonderful [copiaIncolla Open](https://www.copiaincolla.com/copiaincolla-open) initiative. These local groups are the absolute beating heart of open source, and the sheer energy, curiosity, and warmth they bring to every single meetup and discussion is incredibly inspiring.
